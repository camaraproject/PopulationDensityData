Feature: CAMARA Population Density Data API, v0.3.0
  ...
  Background: Common retrievePopulationDensity setup
    ...
    And the resource "/population-density-data/v0.3.0/retrieve"
  ...
  @population_density_data_12_invalid_url
  Scenario: Invalid sink
    Given the request body property  "$.sink" is set to a value other than "azerty"
    When the request "retrievePopulationDensity" is sent
    Then the response status code is 400
    And the response header "x-correlator" has same value as the request header "x-correlator"
    And the response header "Content-Type" is "application/json"
  ...
  @population_density_data_13_expired_access_token
  ...
  @population_density_data_14_invalid_access_token
  ...
  @population_density_data_15_missing_authorization_header
  ...
  @population_density_data_17_non_polygonal_area
  ...
  @population_density_data_18_too_complex_area
  ...
  @population_density_data_19_min_start_time_exceeded
  ...
  @population_density_data_20_max_start_time_exceeded
  ...
  @population_density_data_21_invalid_end_time
  ...
  @population_density_data_22_max_time_period_exceeded
  ...
  @population_density_data_23_timeframe_crosses_request_time
  ...
  @population_density_data_24_unsupported_precision
  ...
  @population_density_data_25_too_big_synchronous_response
  ...
  @population_density_data_27_too_Many_Requests
