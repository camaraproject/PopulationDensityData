...
* The release r2.1 contains the version 0.2.0-rc.1 of the Population Density Data API. The release tag is [r2.1](https://github.com/camaraproject/PopulationDensityData/tree/r2.1).
