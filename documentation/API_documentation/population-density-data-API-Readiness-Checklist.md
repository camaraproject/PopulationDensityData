...
|  6 | User stories                                 |   O   |         O         |    O    |    M   |   N  |  [link](documentation/API_documentation/Population-Density-Data_User_Story.md) |
...
| 10 | API release numbering convention applied     |   M   |         M         |    M    |    M   |   Y  | r4.1 |
| 11 | Change log updated                           |   M   |         M         |    M    |    M   |   Y  | [link](/CHANGELOG.md) |
| 12 | Previous public release was certified        |   O   |         O         |    O    |    M   |   N  |  No  |
| 13 | API description (for marketing)              |   O   |         O         |    M    |    M   |   Y  | [wiki link](https://lf-camaraproject.atlassian.net/wiki/spaces/CAM/pages/808452114/Population+Density+Data+API+description+v2) |
